...
int main(int argc, char *argv[]) {
	...
	double distance_to_decel = (0 - pow(current_velocity, 2)) / (2 * max_speed);
	distance_to_decel = to_au == true ? kmtoau(distance_to_decel) : distance_to_decel;
